...
class ViewController: UITableViewController {
    ...
    @objc func shareTapped() {
        let recommendationMessage = "Check out the 'Storm Viewer' app! You can look at different images of storms and share them with friends!"
        
        let activityViewController = UIActivityViewController(activityItems: [recommendationMessage], applicationActivities: [])
